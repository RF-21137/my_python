...
lbl2 = Label(frame,font=('13'),bg ='Grey')
lbl2.grid()
...
but1 = Button(frame, text = 'Done',width = 14, height = 1, bg = 'Grey', fg = 'Grey',command = enter)
but1.grid()

but2 = Button(frame, text = 'Exit',width = 14, height = 1, bg = 'Grey', fg = 'Grey', command=ex)
but2.grid()
